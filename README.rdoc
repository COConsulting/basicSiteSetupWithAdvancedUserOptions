...
- [ ] Advanced Sign-in and Sign-ups 
	- [X] Integrate [OmniAuth](https://github.com/intridea/omniauth)
		- [X] Offer Facebook
		- [X] Offer Google
		- [X] Offer Twitter
		- [X] Offer Amazon
...
* I added the ability for a user to make their profile private 
* I implemented the bootstrap-switch gem for the boolean variable of 'private'. 
