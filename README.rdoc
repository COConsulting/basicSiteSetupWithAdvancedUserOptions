...
- [ ] I'd like the redirect page after signing in or signing out to be back to the page the user was on, not the home page. But, the request.referer always gives an error. 
	- [ ] Possibly could use a combination of popup module and JSON and AJAX to solve this problem. See: http://blog.andrewray.me/how-to-set-up-devise-ajax-authentication-with-rails-4-0/
...
- [ ] Advanced Sign-in and Sign-ups 
	...
	- [ ] Allow user to use email or username for sign-in
